...
export const mockRecipes: Recipe[] = [
  ...
  },
  {
    ...
    description:
      "Delicate almond meringue cookies with a smooth ganache filling.",
  ...
  },
  {
    ...
    title: "Pad Thai",
    description:
      "Classic Thai stir-fried noodles with a perfect balance of sweet, sour, and savory flavors.",
  ...
  },
  {
    ...
    description:
      "Creamy pasta with a rich egg and cheese sauce, topped with crispy bacon.",
